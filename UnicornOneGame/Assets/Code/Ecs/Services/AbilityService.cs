		...
		public AbilityService(IEnumerable<IHero> heroes, IEnumerable<IEnemy> enemies)
		{
			...
			foreach (var hero in heroes)
			{
				AbilitySet abilitySet = new AbilitySet(
					hero.Abilities.Select(a => new Ability(a.Name, a.Range, a.Damage, a.Cooldown, a.Projectile, a.Effect)).ToArray()
				);
            ...
            {
                AbilitySet abilitySet = new AbilitySet(
                    enemy.Abilities.Select(a => new Ability(a.Name, a.Range, a.Damage, a.Cooldown, a.Projectile, a.Effect)).ToArray()
                );
                abilitySets.Add(abilitySet);
